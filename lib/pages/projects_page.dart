...
class _ProjectsPageState extends State<ProjectsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool mobile = correntWidth < 700 ? true : false;
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              // SizedBox(),
              SizedBox(
                height: mobile == false ? (correntHeidth * 70) / 100 : (correntHeidth * 76)/100 ,
                child: PageView(
                  controller: pc,
                  onPageChanged: (page) {
                    setPageIndex(page);
                  ...
                  children: [
                    ...
                    ProjectWidget(project: project[1], mobile: mobile,),
                    ProjectWidget(project: project[2], mobile: mobile,),
                  ],
                ),
              ),
              SizedBox(
                  ...
                  children: [
                    pageIndex != 0
                        ...
                        : Icon(Icons.navigate_before,
                            size: 34, color: Cores.grafite),
                    SizedBox(
                      width: mobile == true ? 200 : 300,
                      child: BottomNavigationBar(
                        type: BottomNavigationBarType.fixed,
                        showUnselectedLabels: false,
                        iconSize: mobile == true ? 12 : 15,
